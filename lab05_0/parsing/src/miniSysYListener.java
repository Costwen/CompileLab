...
public interface miniSysYListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link miniSysYParser#cmpOp}.
	 * @param ctx the parse tree
	 */
	void enterCmpOp(miniSysYParser.CmpOpContext ctx);
	/**
	 * Exit a parse tree produced by {@link miniSysYParser#cmpOp}.
	 * @param ctx the parse tree
	 */
	void exitCmpOp(miniSysYParser.CmpOpContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link miniSysYParser#fOp}.
	 * @param ctx the parse tree
	 */
	void enterFOp(miniSysYParser.FOpContext ctx);
	/**
	 * Exit a parse tree produced by {@link miniSysYParser#fOp}.
	 * @param ctx the parse tree
	 */
	void exitFOp(miniSysYParser.FOpContext ctx);
}