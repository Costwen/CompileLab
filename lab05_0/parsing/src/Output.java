...
public class Output {
    ...
    public static void opPrint(Register result, String op, String ty, String op1, String op2){
        opPrint(result.toString(), op, ty, op1, op2);
    }
    ...
    public static void alloca(Register register){
        alloca(register.toString());
    }

    public static void load(String reg1, String reg2){
        println("%s = load i32, i32* %s", reg1, reg2);
    }
    public static void load(Register reg1, Register reg2){
        load(reg1.toString(), reg2.toString());
    }
    ...
    public static void store(Register reg1, Register reg2){
        store(reg1.toString(), reg2.toString());
    }
