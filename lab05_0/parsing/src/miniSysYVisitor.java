...
public interface miniSysYVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link miniSysYParser#cmpOp}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitCmpOp(miniSysYParser.CmpOpContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link miniSysYParser#fOp}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFOp(miniSysYParser.FOpContext ctx);
}